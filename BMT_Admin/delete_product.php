          ...
          <div class="col">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Delete the Product</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="type" class="form-control" id="type" value="<?php echo $row['type'];?>" readonly>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <p>Do you sure want to delete this product?</p>
                    </div>
                    <div class="col-md-12 text-center">
                    <a class="btn btn-secondary" href="list_product.php">Cancel</a>
                    <a class="btn btn-danger" href="product_delete_confirmation.php?id=<?php echo $row["id"];?>">Yes</a>

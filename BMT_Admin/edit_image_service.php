          ...
          <div class=container>
            <div class="mt-2">
              <div class="section-title">
                <h3>Edit Image of the Service</h3>
              </div>
              <div class="row">
                <div class="col-lg-3 ">
                  <div class="column">
                ...
                <a href="list_service.php" type="button" class="btn btn-block btn-info"><i class="fas fa-arrow-left"></i> Back to the List of Service<a>
              </div>
            </div>
          </div>
          <!-- /.content -->

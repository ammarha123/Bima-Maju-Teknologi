              ...
              <form role="form" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <textarea id="introduction" name="introduction" rows="4" cols="162"><?php echo $row['introduction'];?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="vision">Vision</label>
                    <textarea id="vision" name="vision" rows="4" cols="162"><?php echo $row['vision'];?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="mission">Mission</label>
                    <br>
                    <textarea id="mission" name="mission" rows="4" cols="162"><?php echo $row['mission'];?></textarea>
                  </div>

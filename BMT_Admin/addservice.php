...
if (isset($_POST['upload'])) {
  ...
  if ($_FILES["image"]["error"] == 4) {
    ...
    if (!in_array($imageExtension, $validImageExtension)) {
      ...
      $query = "INSERT INTO list_service VALUES('', '$title','$description', '$newImageName')";
                ...
                <form method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="description" class="form-control" name="description" id="descrpition" placeholder="Description" required>
                    </div>
